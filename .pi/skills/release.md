...
This procedure applies only to an upstream `earendil-works/pi` checkout. Do not
run its release commands in this personal fork: it has no GitHub
release-publishing workflow. Use [FORK.md](../../FORK.md) for locally validated
fork installation and activation.

Run repository commands from the upstream checkout root, unless instructed otherwise.
