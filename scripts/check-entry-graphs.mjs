...
const BUDGETS = {
	...
	"packages/agent": {
		...
		// Includes pipe decoding and the cancellation-free context used to preserve final output.
		"./harness/env/nodejs": { maxFiles: 8, forbid: ["packages/ai/", "harness/runtime/"] },
