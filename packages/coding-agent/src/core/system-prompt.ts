...
- For Pi work, read task-relevant docs and examples from the running or target Pi version; follow cross-references that resolve material API or contract questions before implementing
- Read a Pi .md file completely and follow needed links when its full context is required for correctness or the owner explicitly requests full reading`;
	}
